# 12 — Distribute via the Gemini Enterprise app
...
## 12.1 Make sure you have a Gemini Enterprise license
...
- **Icon:** upload a 256×256 PNG, or pick from the icon library.
...
## 12.4 Verify the agent shows up
...
## 12.5 Inbox for long-running tasks
...
## 12.6 Agent Designer — no-code agents for end users
...
## 12.7 Agent Gallery and marketplace agents
...
## 12.8 Mix agents into Workspace
...
## 12.9 Branding and custom domains
...
## 12.11 Iterate based on real traffic

Hook the same dashboard from section 11 to a "user satisfaction" metric:
...
- Re-run section 11.B's Auto SxS to confirm improvement.
- Ship.
...
Move on to **`13_checklist_and_cleanup.md`** for final verification and cleanup.
